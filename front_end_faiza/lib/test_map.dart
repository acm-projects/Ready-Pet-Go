...
//import 'package:rpg_test/ui/finish_walk.dart';
import 'package:front_end_faiza/finish_walk.dart';
import 'package:stop_watch_timer/stop_watch_timer.dart';
//tools:overrideLibrary="io.flutter.plugins.googlemaps";
...
class _TestMapState extends State<TestMap> {
          ...
          actions: [
            TextButton(
              ...
              style: TextButton.styleFrom(
                primary: Color(0xFF00A5E0),
                textStyle: const TextStyle(fontWeight: FontWeight.w600),
              ),
              child: const Text('DONE', style: TextStyle(fontFamily: 'Nunito', fontWeight: FontWeight.w700, fontSize: 15)),
            )
          ],
        ),
        body: Stack(
  ...
  Future<Uint8List> getMarker() async {
    ByteData byteData = await DefaultAssetBundle.of(context)
        .load("assets/images/dog_icon_walking.png");
